...
#define UE_PROJECT_NAME Libs
#define UE_TARGET_NAME LibsEditor
#define UE_MODULE_NAME "AstraAIAgent"
#define UE_PLUGIN_NAME "AstraAIAgent"
...
#define ASTRAAIAGENT_API DLLEXPORT
